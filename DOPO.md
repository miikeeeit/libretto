...
- **Alleggerire il pacchetto JavaScript** — alla fine delle sei settimane sono **982 kB (258 kB compressi)**, quasi tutti SDK Firebase. Nella settimana 1 erano 705 kB (184 kB): la differenza sono i moduli Functions e Storage, aggiunti con la conferma e la foto. Il numero è cresciuto del 40% mentre nessuno lo guardava, e conviene tenerne conto quando si riapre questa voce. Su una 3G di fine agosto si sente, e chi apre un profilo da un annuncio è proprio chi ha la rete peggiore. Si può caricare Firestore, Functions e Storage solo quando servono e tenere leggera la pagina pubblica, che è quella che deve aprirsi in fretta — oggi si porta dietro anche il codice della conferma e del caricamento foto, che a un datore non servono mai. Rimandato perché non è nella specifica e perché prima va misurato sul telefono vero, non stimato.
